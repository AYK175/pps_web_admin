...
import 'package:pps_web_admin/pages/Users/USEREDIT/widgets/UserEdit_body.dart';
...
class UserEditScreen extends StatelessWidget {
  Users users;
   ...
   UserEditScreen({Key? key,required this.users}) : super(key: key);
      ...
      body: SafeArea(
        child: Row(
          ...
          children: [
            ...
            Expanded(
              flex: 9,
              child: UserEditBody(users: users,),
            )
          ],
        ),
      ),
