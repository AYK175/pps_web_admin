            ...
            child: Column(
              ...
              children: [
                StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance.collection("vets").where("ProfileStatus",isEqualTo: "Unapproved").where("ProfileUnapprovalReason",isEqualTo: "New User").snapshots(),
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                                      return VetsProfileScreen(vets: vet, VetID:vetsss.id,);
                                    }));
                                  },
