...
import '../../VETPROFILE/widgets/VetsProfile_body_content.dart';

class ReSchedulingBodyContent extends StatelessWidget {
  String vetID;
  String clinicID;
  String serviceID;
  String servicePrice;
  String bookingId;
   ...
   ReSchedulingBodyContent({Key? key,required this.vetID, required this.clinicID, required this.serviceID, required this.servicePrice,required this.bookingId}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            AppointReScheduleCLINICsnew2(vetID: vetID, clinicID: clinicID, servicePrice: servicePrice, serviceID: serviceID, bookingId: bookingId,),
            ],
        ),
      ),
    );
...
class AppointReScheduleCLINICsnew2 extends StatefulWidget {
  String vetID;
  String clinicID;
  String serviceID;
  String servicePrice;
  ...
  AppointReScheduleCLINICsnew2(
      {Key? key, required this.vetID, required this.clinicID, required this.serviceID, required this.servicePrice,required this.bookingId})
      : super(key: key);

  @override
  State<AppointReScheduleCLINICsnew2> createState() => _AppointReScheduleCLINICsnew2State();
}

class _AppointReScheduleCLINICsnew2State extends State<AppointReScheduleCLINICsnew2> {
  ...
  void initState() {
    ...
    fetchVetData().then((value) {
      ...
      mockBookingService = BookingService(
        ...
        userId: user.uid,
        userName: "Accepted",//appointment status
        userPhoneNumber: "NotGiven",
      );
  ...
  Future<void> fetchVetData() async {
    try {
      ...
      await FirebaseFirestore.instance.collection('Clinics').doc(
          widget.clinicID).get();
  ...
  getData(BookingService booking) async {
    ...
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection(
        ...
        "userName", whereIn: ['Accepted', 'Cancelled by Vet']).get();
  ...
  Future<dynamic> uploadBookingMock(
    ...
    Navigator
      ...
      return VetProfileDetails(VetID: widget.vetID); }
    ));
  }
