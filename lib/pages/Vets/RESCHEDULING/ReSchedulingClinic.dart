...
import 'package:pps_web_admin/pages/Vets/VETPROFILE/widgets/VetsProfile_body_content.dart';
...
class AppointReScheduleCLINICsnew extends StatefulWidget {
  String vetID;
  String clinicID;
  String serviceID;
  String servicePrice;
  ...
  AppointReScheduleCLINICsnew(
      ...
      required this.bookingId,
        ...
        required this.BookUserEmail
      })
      : super(key: key);

  @override
  State<AppointReScheduleCLINICsnew> createState() =>
      _AppointReScheduleCLINICsnewState();
}

class _AppointReScheduleCLINICsnewState
    extends State<AppointReScheduleCLINICsnew> {
  ...
  void initState() {
    ...
    fetchVetData().then((value) {
      ...
      mockBookingService = BookingService(
        ...
        bookingEnd: DateTime(now.year, now.month, now.day, endhour + 1, endmin),
        bookingStart:
  ...
  getData(BookingService booking) async {
    ...
    QuerySnapshot snapshot = await FirebaseFirestore.instance
        .collection("booking")
        .where("serviceId", isEqualTo: widget.vetID)
        .where("userName", whereIn: ['Accepted', 'Cancelled by Vet']).get();
  ...
  Future<dynamic> uploadBookingMock(
    ...
    FirebaseFirestore.instance
        ...
        .update(newBooking
            .toJson()); //print('${newBooking.toJson()} has been uploaded');
