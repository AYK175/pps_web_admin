                  ...
                  children: [
                    StreamBuilder<QuerySnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        print('Cancelled documents count: $cancelledCount');
                        final GlobalKey<AnimatedCircularChartState> _chartKey = new GlobalKey<AnimatedCircularChartState>();
                        List<CircularStackEntry> data = <CircularStackEntry>[
                          new CircularStackEntry(
                            <CircularSegmentEntry>[
                              new CircularSegmentEntry(cancelledCount.toDouble(), Colors.green[200], rankKey: 'Cancelled Bokings'),
                              new CircularSegmentEntry(completedCount.toDouble(), Colors.blue[200], rankKey: 'Completed Bokings'),
                              ],
                            rankKey: 'Bookings',
                          ),
                        ];
                                    ...
                                    Center(
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'Total Cancelled Bookings: $cancelledCount',
                                            style: TextStyle(
                                                fontSize: 16,
