            ...
            child: Column(
              ...
              children: [
                ...
                StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance.collection("vet_funds_withdrawal_request").where("Status",isEqualTo: "WithdrawRequested").orderBy("Date", descending: false)
                      .snapshots(),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot) {
                          ...
                          String IBAN = snapshot.data!.get('ibanNumber') ?? '';
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance.collection("vet_funds_withdrawal_request").where("Status",isEqualTo: "WithdrawRequested").orderBy("Date", descending: true)
                      .snapshots(),
                  builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                    if (snapshot.hasError) {
                      return Text('Error: ${snapshot.error}');
