                            ...
                            children: [
                              ...
                              Expanded(child: Container(
                                ...
                                child:ListView(children: [
                                  ...
                                  Padding(padding: EdgeInsets.only(left: width*0.0,top: height*0.01),
                                    child: Center(child: Text("Vet Liceance:",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),)),),
                                  Padding(padding: EdgeInsets.only(left: width*0.0,top: height*0.01, bottom: height*0.01),
                                  ...
                                  Padding(padding: EdgeInsets.only(left: width*0.0,top: height*0.01, bottom: height*0.01),
                                    child: Center(child: Text('${data['qualification']}')),),

                                  Padding(padding: EdgeInsets.only(left: width*0.0,top: height*0.01),
                                    child: Center(child: Text("specialization:",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),)),),
                                  Padding(padding: EdgeInsets.only(left: width*0.0,top: height*0.01, bottom: height*0.01),
                                  ...
                                  Padding(padding: EdgeInsets.only(left: width*0.0,top: height*0.01),
                                    child: Center(child: Text("Timing:",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),)),),
